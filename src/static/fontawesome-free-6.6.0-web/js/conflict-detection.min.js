...
;(t = function () {
  ...
  a &&
    ((s = (l.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(l.readyState)),
  ...
  var c =
    ((function (t) {
      ...
      function r(t, e) {
        ...
        for (
          var r = 1732584193, s = -271733879, c = -1732584194, f = 271733878, l = 0;
          l < t.length;
          l += 16
        )
          (r = u((n = r), (o = s), (a = c), (i = f), t[l], 7, -680876936)),
      ...
      function o(t) {
        for (var e, n = '0123456789abcdef', o = '', a = 0; a < t.length; a += 1)
          (e = t.charCodeAt(a)), (o += n.charAt((e >>> 4) & 15) + n.charAt(15 & e))
        return o
      }
      function n(t) {
      ...
      function i(t, e) {
        return (function (t, e) {
          var n,
            ...
            i = []
          for (
            a[15] = i[15] = void 0, 16 < o.length && (o = r(o, 8 * t.length)), n = 0;
            n < 16;
            n += 1
          )
  ...
  function T(t) {
    ...
    f.onmessage = function (t) {
      ;('file://' !== f.location.origin && t.origin !== f.location.origin) ||
        (t &&
          t.data &&
    ...
    var o = (function (e) {
      ...
      t = (function () {
        var e = Array.from(l.getElementsByTagName('link')).filter((t) => !t.hasAttribute(w)),
          ...
          if (0 < (t = Object.keys(n.conflict).length)) {
            ...
            for (var i in n.conflict) {
              ...
              c[i] = {
                ...
                'innerText excerpt':
                  f.innerText && '' !== f.innerText ? f.innerText.slice(0, 200) + '...' : '(empty)'
              }
            }
            console.table(c)
          }
          ...
          if (0 < (t = Object.keys(a).length)) {
            ...
            for (var s in a) {
              ...
              u[s] = {
                ...
                'innerText excerpt':
                  h.innerText && '' !== h.innerText ? h.innerText.slice(0, 200) + '...' : '(empty)'
              }
            }
            console.table(u)
          }
