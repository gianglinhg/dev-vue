...
!(function () {
  ...
  f &&
    ((yt = (w.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(w.readyState)),
  ...
  function qt(t, e) {
    ...
    return (
      ...
      a.prefix ||
        ...
        ((a.prefix = 'fass'), (a.iconName = Wt(a.prefix, a.iconName) || a.iconName)),
      a.prefix ||
        s !== p ||
        (!St.fasds && !et.autoFetchSvg) ||
        ((a.prefix = 'fasds'), (a.iconName = Wt(a.prefix, a.iconName) || a.iconName)),
      ...
      parse: {
        icon: (t) => {
          ...
          if ('object' == typeof t && t.prefix && t.iconName)
            return { prefix: t.prefix, iconName: Wt(t.prefix, t.iconName) || t.iconName }
  ...
  function ie(t) {
    ...
    u && (h.attributes[C] = ''),
      s &&
        (h.children.push({
          tag: 'title',
          attributes: { id: h.attributes['aria-labelledby'] || 'title-'.concat(l || ot()) },
          children: [s]
        }),
            ...
            return [
              {
                ...
                children: [{ tag: 'symbol', attributes: { ...r, id: t }, children: n }]
              }
            ]
          }
        : function (t) {
  ...
  function fe(r, i) {
    ...
    return (
      ...
      new Promise((t, e) => {
        var a, n
        if (
          ('fa' === o && ((n = _t(r) || {}), (r = n.iconName || r), (i = n.prefix || i)),
          r && i && se[i] && se[i][r])
        )
          return t(ce(se[i][r]))
        ;(a = r),
          ...
          R ||
            ...
            !a ||
            console.error(
              'Icon with name "'.concat(a, '" and prefix "').concat(n, '" is missing.')
            ),
    ...
    nest: function (t) {
      ...
      if ((delete a[0].attributes.id, a[0].attributes.class)) {
        const r = a[0].attributes.class
          .split(' ')
          .reduce(
            (t, e) => ((e === et.replacementClass || e.match(n) ? t.toSvg : t.toNode).push(e), t),
            { toNode: [], toSvg: [] }
          )
    ...
    return (
      ...
      (r.iconName && r.prefix) ||
        (r.prefix &&
          0 < n.length &&
          (r.iconName =
            ((a = r.prefix), (n = t.innerText), (Ft[a] || {})[n] || Ht(r.prefix, Ot(t.innerText)))),
        !r.iconName &&
          et.autoFetchSvg &&
          t.firstChild &&
      ...
      return re(
        ...
        () => (
          ...
          ie({
            icons: {
              main: ce(d),
              mask: r ? ce(r.icon) : { found: !1, width: null, height: null, icon: {} }
            },
            prefix: u,
            iconName: m,
            transform: { ...rt, ...a },
            ...
            return re({ type: 'layer' }, () => {
              ...
              return (
                ...
                [
                  {
                    tag: 'span',
                    attributes: { class: [''.concat(et.cssPrefix, '-layers'), ...n].join(' ') },
                    children: e
                  }
                ]
              )
      ...
      if (c && 'none' !== m && '' !== m) {
        ...
        if (
          (h &&
            ...
            (h = Ht('fas', h)),
            (h = d ||
              (h ? { prefix: 'fas', iconName: h } : null) || { prefix: null, iconName: null })
              .iconName &&
              h.prefix &&
          ...
          t.generateAbstractMask = function (t) {
            ...
            var { width: l, icon: f } = r,
              ...
              l = {
                tag: 'g',
                attributes: { ...u.inner },
                children: [qe({ tag: c.tag, attributes: { ...c.attributes, ...u.path }, ...t })]
              },
              ...
              return (
                i ||
                  r.children.push(
                    {
                      tag: 'animate',
                      attributes: { ...a, attributeName: 'r', values: '28;14;28;28;14;28;' }
                    },
                ...
                t.push({
                  ...
                  children: i
                    ? []
                    : [{ tag: 'animate', attributes: { ...n, values: '1;0;0;0;0;1;' } }]
                }),
                i ||
                  t.push({
                    tag: 'path',
